...
/**
 * Created by wangjian on 2016/8/9.
 */
public class RRelativeLayout extends RelativeLayout{
    ...
    public RRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnRippleCompleteListener {
        void onComplete(RRelativeLayout rippleView);
    }
